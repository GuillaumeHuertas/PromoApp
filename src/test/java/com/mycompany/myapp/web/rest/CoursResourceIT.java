...
public class CoursResourceIT {
    ...
    private static final Integer DEFAULT_NUMBER_STUDENT = 1;
    private static final Integer UPDATED_NUMBER_STUDENT = 2;
    ...
    public static Cours createEntity(EntityManager em) {
        Cours cours = new Cours()
            .name(DEFAULT_NAME)
            .numberStudent(DEFAULT_NUMBER_STUDENT)
    ...
    public static Cours createUpdatedEntity(EntityManager em) {
        Cours cours = new Cours()
            .name(UPDATED_NAME)
            .numberStudent(UPDATED_NUMBER_STUDENT)
    ...
    public void createCours() throws Exception {
        ...
        assertThat(testCours.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testCours.getNumberStudent()).isEqualTo(DEFAULT_NUMBER_STUDENT);
        assertThat(testCours.getTeacher()).isEqualTo(DEFAULT_TEACHER);
    }
    ...
    public void getAllCours() throws Exception {
        ...
        restCoursMockMvc.perform(get("/api/cours?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numberStudent").value(hasItem(DEFAULT_NUMBER_STUDENT)))
    ...
    public void getCours() throws Exception {
        ...
        restCoursMockMvc.perform(get("/api/cours/{id}", cours.getId()))
            ...
            .andExpect(jsonPath("$.numberStudent").value(DEFAULT_NUMBER_STUDENT))
    ...
    public void updateCours() throws Exception {
        ...
        Cours testCours = coursList.get(coursList.size() - 1);
        assertThat(testCours.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testCours.getNumberStudent()).isEqualTo(UPDATED_NUMBER_STUDENT);
        assertThat(testCours.getTeacher()).isEqualTo(UPDATED_TEACHER);
    }
