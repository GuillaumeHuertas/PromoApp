...
describe('Service Tests', () => {
  describe('Apprenant Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Apprenant(0, 'AAAAAAA', 'AAAAAAA', currentDate, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Apprenant', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            birthdate: currentDate.format(DATE_FORMAT)
      ...
      it('should update a Apprenant', async () => {
        const returnedFromService = Object.assign(
          {
            firstname: 'BBBBBB',
            lastname: 'BBBBBB',
      ...
      it('should return a list of Apprenant', async () => {
        const returnedFromService = Object.assign(
          {
            firstname: 'BBBBBB',
            lastname: 'BBBBBB',
      ...
      it('should delete a Apprenant', async () => {
